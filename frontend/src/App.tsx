  ...
  return <Box sx={{ minHeight: "100vh", bgcolor: "#070c12", color: "#fff", display: "flex", overflow: "hidden", fontFamily: "Inter, Segoe UI, sans-serif" }}>
    <Box component="aside" sx={{ width: 212, flexShrink: 0, bgcolor: "#090f16", borderRight: "1px solid #1d2732", display: "flex", flexDirection: "column", zIndex: 1300 }}>
      ...
      <Box sx={{ px: 1.5, py: 2, flex: 1 }}>
        ...
        <Box sx={{ mt: 2, border: "1px solid #1d2732", borderRadius: 1.5, p: 1.5, bgcolor: "#0c131b" }}><Typography sx={{ color: "#f0f3f7", fontSize: 10, fontWeight: 800, mb: 1.4 }}>SYSTEM STATUS</Typography>{["AI Provider", "Floor Detection", "Render Engine"].map((label, i) => <Box key={label} sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1 }}><Typography sx={{ color: "#8995a3", fontSize: 9 }}>{label}</Typography><Chip label={i === 0 ? "Light (Local)" : "Enabled"} size="small" sx={{ height: 18, bgcolor: "#15351f", color: "#61d884", fontSize: 8 }} /></Box>)}<Box sx={{ display: "flex", alignItems: "center", gap: .7, mt: 1 }}><Box sx={{ width: 7, height: 7, borderRadius: "50%", bgcolor: "#39c96a" }} /><Typography sx={{ color: "#52d47a", fontSize: 9 }}>Operational</Typography></Box><Typography sx={{ color: "#697685", fontSize: 9, mt: 1 }}>Version v2.1.0 · Production</Typography></Box>
      </Box>
